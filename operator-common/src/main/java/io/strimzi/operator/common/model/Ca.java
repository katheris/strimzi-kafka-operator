...
public abstract class Ca {
    ...
    public Ca(Reconciliation reconciliation, CertManager certManager, PasswordGenerator passwordGenerator, String commonName,
              ...
              int validityDays, int renewalDays, boolean generateCa, CertificateManagerType certificateManagerType, CertificateExpirationPolicy policy, IssuerRef issuerRef) {
    ...
    private CertAndKey generateSignedCert(Subject subject) throws IOException {
        ...
        CertAndKey result = generateSignedCert(subject, csrFile, keyFile, certFile, keyStoreFile);
