...
public class CaReconciler {
    ...
    public Future<CaReconciliationResult> reconcile(Clock clock)    {
        return reconcileCas(clock)
                ...
                .compose(i -> maybeRollingUpdateForNewCaKey())
     ...
     */
    Future<Void> maybeRollingUpdateForNewCaKey() {
    ...
    /**
     * Patches the Kafka StrimziPodSets to update the Cluster CA key and returns the nodes.
     *
