...
public class ClusterCa extends Ca {
    ...
    @Override
    public void maybeUpdateCertAndGenerations(String caCert, X509Certificate endEntityCertificate) {
        if (this.caCertData == null) {
            ...
            if (doesEECertTrustCa(endEntityCertificate, x509CaCert)) {
                // No key replacement
                Map<String, String> newCaCertData = new HashMap<>();
                newCaCertData.put(CA_CRT, caCert);
                this.caCertData = newCaCertData;
                ...
                // key replacement
                X509Certificate currentCert = cert(caCertSecretName, caCertData, CA_CRT);
    ...
    private boolean doesEECertTrustCa(X509Certificate endEntityCertificate, X509Certificate caCert) {
        ...
        try {
            ...
            eeCertPath = factory.generateCertPath(List.of(endEntityCertificate));
